...
| [layout.md](layout.md) | Cells and the pin grid, the MaxRects packer and its heuristics, dividers, dots, the alignment datum (slots, holes, none), the report, and a worked example with real numbers. |
